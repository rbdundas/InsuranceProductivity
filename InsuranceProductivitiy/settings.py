"""
Django settings for InsuranceProductivitiy project.
...
SECRET_KEY = 'django-insecure-amb!!p==ynhw^$o8*e$$2kz^=2)cd!oef)#3_e5%_+q6or+j4_'
...
ROOT_URLCONF = 'InsuranceProductivitiy.urls'
...
WSGI_APPLICATION = 'InsuranceProductivitiy.wsgi.application'
